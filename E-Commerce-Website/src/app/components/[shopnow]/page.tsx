...
interface ProductType 
    ...
    return(
        ...
        <section className="w-full max-w-[1439px] bg-[#FAFAFA] py-2 flex flex-col items-center justify-center max-md:w-full max-md:max-w-3xl">
                {
                data.map((item, index) => (
                    <div key={index} className="w-full max-w-[1050px] flex gap-10 pb-[40px] max-md:flex-col">
                        <div className="w-1/2 flex flex-col gap max-md:gap-2">
                            <div className="w-[506px] h-[450px] p-10 flex justify-between">
                        ...
                        <div className="w-1/2 flex flex-col gap-6 p-6 max-md:w-full">
                            <h4 className="text-[20px] text-[#252B42]">{item.title}</h4>
                            ...
                            <h4 className="text-[24px] text-[#252B42]">${item.price}</h4>
                            <h6 className="text-[#737373] text-[14px] font-bold">Available Stock  : <span className="text-[14px] font-bold text-[#23A6F0]">{item.stock}</span></h6>
